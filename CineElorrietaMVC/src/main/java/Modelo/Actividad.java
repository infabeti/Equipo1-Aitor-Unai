...
public class Actividad {
	...
	public Actividad(int numTransaccion) { //Este constructor existe únicamente para crear una Actividad que solo tiene el número de transacción y usarla para buscar en la lista ligada
		this.numTransaccion = numTransaccion;
	}
